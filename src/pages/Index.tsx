...
const Index = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Loading Plutoid...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Fixed Sidebar */}
      <BlueskySidebar currentUser={currentUser} className="fixed left-0 top-0 h-screen z-50" />

      {/* Main Content */}
      <div className="ml-64 min-h-screen max-w-2xl mx-auto">
